...
export const FAMOUS_OFFICERS={
 ...
 'person-558':entry('庞统','连环谋攻','archer',mental('连环计',70,30,4,.9,{targets:3,radius:1,debuff:'slow',steps:4}),['scholar','spirit','combo','discipline'],cap('凤雏','debuffed','intellect',.14)),
 ...
 'person-371':entry('孙策','突阵压制','cavalry',physical('小霸王',70,28,2,1.5,{debuff:'weaken',steps:5}),['assault','martial','rider','joint'],cap('霸业','healthy','force',.18)),
 ...
 'person-119':entry('甘宁','近战袭扰','cavalry',physical('百骑劫营',65,28,2,1.45,{drain:20}),['assault','spirit','rider','joint'],cap('锦帆','isolated','force',.22)),
 ...
 'person-226':entry('司马懿','后发压制','crossbow',mental('鹰视狼顾',70,30,4,1.1,{drain:25,debuff:'weaken',steps:4}),['scholar','discipline','suppress','calm'],cap('隐忍','late','intellect',.2)),
...
const kindText={force:'武力战法伤害',intellect:'智力战法伤害',basic:'普攻伤害',defense:'防御与军纪',support:'护盾、战意及冷却缩减量'};
...
export function famousTacticDescription(s){
 ...
 if(s.burn)parts.push(`灼烧每步基础 ${s.burn}，持续 ${s.steps} 步，按兵力与目标军纪衰减`);
