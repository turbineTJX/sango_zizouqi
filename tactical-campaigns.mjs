...
export const TACTICAL_CAMPAIGNS=[
  ...
  },
  {
    ...
    ownTeam:[unit(U.liu,'logistics',500,['unique-person-636','supply','regrowth']),unit(U.guan,'cavalry',3800,['unique-person-99','gallop','rush']),unit(U.zhang,'spear',4200,['unique-person-433','phalanx','strike'])],
