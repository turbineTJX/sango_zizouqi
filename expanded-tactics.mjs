...
export const EXPANDED_TACTICS={
 ...
 regrowth:skill('休整','politics',55,30,2,'regrowth','为一队友军施加 6 步持续救护，每步最多救治兵力上限的 1.5%＋营务威力/50000；施放后重置普攻间隔','持续救护','不能复活；受减疗和伤兵预算限制，重复施放不叠加'),
 ...
 tremor:skill('震军','intellect',35,28,4,'tremor','震击相邻最多两队（0.75 倍谋略），使其普攻间隔 +25%、谋略威力 −15%，持续 6 步','群体压制','没有硬控，不阻止移动或施法'),
