...
export const TACTICAL_CAMPAIGNS=[
  ...
  },
  {
    ...
    ownTeam:[unit(U.liu,'logistics',1950,['unique-person-636','supply','regrowth']),unit(U.guan,'cavalry',3600,['unique-person-99','gallop','rush']),unit(U.zhang,'spear',2950,['unique-person-433','phalanx','strike'])],
  ...
  },
  {
    ...
    briefing:'简雍随前排治疗与输粮，诸葛亮封技，关张稳住阵线，赵云追击后排。守到第 240 步、城门未破且尚有可战部队即完成掩护；城门失守、守军全灭或撤退失败。',
  ...
  },
  {
    ...
    enemyTeam:[unit('cao','spear',3900),unit('dun','halberd',3200),unit('yuanxia','archer',2900),unit('person-472','spear',2800),unit('jia','crossbow',1700),unit('yu','logistics',1900)],seed:521305,
  },
