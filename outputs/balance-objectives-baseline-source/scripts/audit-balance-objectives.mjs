...
const initial=hashes(),runs=[],rows=[];
...
if(phase==='train'){
 ...
 writeFileSync(new URL('../selection.json',out),JSON.stringify({trainingSeeds:TRAIN_SEEDS,validationSeeds:VALIDATION_SEEDS,selected},null,2));
}
if(phase==='validate'){
