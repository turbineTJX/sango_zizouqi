...
export function modeLobby() {
  return `<main class="campaign-lobby mode-lobby">
    ...
    </section><footer class="lobby-footer"><p>两种模式分别保存进度，可随时返回首页切换。</p><div><button class="text-button" data-action="scenarios">演武试炼</button></div></footer>
  </main>`;
}
