...
export const EXPANDED_TACTICS={
 ...
 ram:skill('撞城','force',50,28,2,'ram','优先撞击两格内敌方城门（3 倍攻城攻击）；无城门目标时攻击一队敌军（1.1 倍武技）','攻城突击','需要推进至近处，无法同时保持远程安全'),
 emplace:skill('架设','force',35,28,5,'emplace','交战时架设 10 步：攻击 +20%、普攻与武力射击射程 +1，期间无法移动','定点火力','无法转场，仍有两格普攻盲区'),
 plague:skill('疫矢','intellect',40,26,5,'plague','命中（0.6 倍谋略），施加 10 步疫伤和 10 步 50% 减疗；疫伤每步基础 12＋谋略威力×0.08，受军纪与兵力影响，不叠加','疫伤压疗','持续伤害兑现较慢；净化可同时清除疫伤和减疗'),
