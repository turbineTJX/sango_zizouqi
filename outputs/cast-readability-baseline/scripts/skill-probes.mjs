...
{
  const {b,u,enemy}=mini();u.tactics=['gallop','rush','harass'];
  ...
  const test=mini();test.u.tactics=['gallop','rush','harass'];Object.assign(test.u,{x:3,y:4});Object.assign(test.enemy,{x:10,y:4});
...
function fireProbe(hp){
  const {b,u,enemy}=mini();u.type='archer';u.tactics=['fire','scatter','suppress'];
