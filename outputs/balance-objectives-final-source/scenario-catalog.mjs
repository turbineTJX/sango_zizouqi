...
export const SCENARIOS = [
 ...
 {id:'eight-arms',name:'演武 · 诸兵协同',kind:'野战',difficulty:'新兵种',description:'枪戟稳阵，骑兵突击，辅兵近战协阵，兵器疫伤减疗，弓兵持续输出。双方同兵力同等级，从零战意开战。',own:6,enemy:6,ownTroops:3000,enemyTroops:3000,level:5,enemyLevel:5,waves:[],seed:521216,limit:240,goal:'观察衰咒、减疗、幻卫与开路的配合；可在开战前重配六选三。'},
