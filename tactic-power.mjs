...
export const DURATION_POWER_STATUSES=new Set(['stun','confuse','seal','taunt','resolve','haste','riposte','phase','pursuit','burningAttack','strategyAttack','cursingAttack']);
...
export function tacticPowerProfile(s){
  ...
  return {attribute:s.category==='intellect'?'strategyPower':'martialPower',name:s.category==='intellect'?'谋略威力':'武技威力',checks,critical};
}
