const CACHE = 'sango-v1-20260917-tactic-combos';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './engine.mjs', './tactics.mjs', './battle-effects.mjs', './icon.svg', './manifest.webmanifest'];
